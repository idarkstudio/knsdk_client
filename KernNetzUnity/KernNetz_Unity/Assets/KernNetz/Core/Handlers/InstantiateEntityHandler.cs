...
namespace KernNetz.Handlers
{
    internal class InstantiateEntityHandler : IHandler
    {
        ...
        public void HandleMessage(Message message, uint PeerId)
        {
            ...
            System.Numerics.Vector4 rot = System.Numerics.Vector4.Zero;
            ...
            {
                var rotData = Default_Serializer.Deserialize2<FNVector4>((byte[])operation.Parameters[6]); // operation.Parameters[6] as object[];
                ...
                rot = new Vector4(_vec3Pos.X, _vec3Pos.Y, _vec3Pos.Z, _vec3Pos.W);
            }
