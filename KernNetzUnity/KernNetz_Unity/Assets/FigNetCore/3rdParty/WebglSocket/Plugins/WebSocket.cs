...
public class WebSocket : IWebSocket
{
    ...
    public WebSocket(string URL, bool isSceure)
    {
        ...
        if (isSceure)
        {
            this.WS.SslConfiguration.EnabledSslProtocols =  System.Security.Authentication.SslProtocols.Tls11 |
        ...
        //    this.WS.Log.Output = (data, message) =>
        //    {
        //        UnityEngine.Debug.LogError($"WS Internal : {data.Message}");
        //    };
        //}
...
public static class WebSocketFactory
{
    ...
    public static WebSocket CreateInstance(string URL, bool isSceure)
    {
#if UNITY_WEBGL && !UNITY_EDITOR
        if(!IsInitialized)
            Initialize();
        ...
        return Wrapper;
#else
        return new WebSocket(URL, isSceure);
#endif
    }
}