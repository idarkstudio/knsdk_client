    ...
    internal static class GeneratedResolverGetFormatterHelperEntangle
    {
        ...
        static GeneratedResolverGetFormatterHelperEntangle()
        {
            lookup = new global::System.Collections.Generic.Dictionary<Type, int>(26)
            {
                ...
                { typeof(global::System.Collections.Generic.List<global::KernNetz.ENStateFrame>), 2 },
                { typeof(global::System.Collections.Generic.List<global::FigNetCommon.RoomInfo>), 3 },
                { typeof(global::System.Collections.Generic.KeyValuePair<byte, global::FigNet.KernNetz.EntangleState>), 4 },
                ...
                { typeof(global::FigNet.KernNetz.EntangleState), 9 },
                { typeof(global::KernNetz.ENStateFrame), 10 },
                { typeof(global::KernNetz.ENStateFrameBatch), 11 },
        ...
        internal static object GetFormatter(Type t)
        {
            ...
            switch (key)
            {
                ...
                case 2: return new global::MessagePack.Formatters.ListFormatter<global::KernNetz.ENStateFrame>();
                case 3: return new global::MessagePack.Formatters.ListFormatter<global::FigNetCommon.RoomInfo>();
                case 4: return new global::MessagePack.Formatters.KeyValuePairFormatter<byte, global::FigNet.KernNetz.EntangleState>();
...
namespace MessagePack.Formatters.FigNet.Entangle
{
    ...
    public sealed class EntangleStateFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::FigNet.KernNetz.EntangleState>
    {
        ...
        public void Serialize(ref MessagePackWriter writer, global::FigNet.KernNetz.EntangleState value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value == null)
            {
                writer.WriteNil();
        ...
        public global::FigNet.KernNetz.EntangleState Deserialize(ref MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (reader.TryReadNil())
            {
                return null;
...
namespace MessagePack.Formatters.Entangle
{
    ...
    public sealed class ENStateFrameFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::KernNetz.ENStateFrame>
    {
        ...
        public void Serialize(ref MessagePackWriter writer, global::KernNetz.ENStateFrame value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value == null)
            {
                writer.WriteNil();
            ...
            formatterResolver.GetFormatterWithVerify<global::FigNet.KernNetz.EntangleState>().Serialize(ref writer, value.State, options);
        }

        public global::KernNetz.ENStateFrame Deserialize(ref MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (reader.TryReadNil())
            {
                return null;
            ...
            var __State__ = default(global::FigNet.KernNetz.EntangleState);
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                switch (key)
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        __State__ = formatterResolver.GetFormatterWithVerify<global::FigNet.KernNetz.EntangleState>().Deserialize(ref reader, options);
                        break;
                    default:
                        reader.Skip();
                        break;
    ...
    public sealed class ENStateFrameBatchFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::KernNetz.ENStateFrameBatch>
    {
        ...
        public void Serialize(ref MessagePackWriter writer, global::KernNetz.ENStateFrameBatch value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value == null)
            {
                writer.WriteNil();
            ...
            formatterResolver.GetFormatterWithVerify<global::System.Collections.Generic.List<global::KernNetz.ENStateFrame>>().Serialize(ref writer, value.ENStateFrames, options);
        }

        public global::KernNetz.ENStateFrameBatch Deserialize(ref MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (reader.TryReadNil())
            {
                return null;
            ...
            var __ENStateFrames__ = default(global::System.Collections.Generic.List<global::KernNetz.ENStateFrame>);
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                switch (key)
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        __ENStateFrames__ = formatterResolver.GetFormatterWithVerify<global::System.Collections.Generic.List<global::KernNetz.ENStateFrame>>().Deserialize(ref reader, options);
                        break;
                    default:
                        reader.Skip();
                        break;
...
namespace MessagePack.Formatters.FigNetCommon
{
    ...
    public sealed class EntityDefaultStateFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::FigNetCommon.EntityDefaultState>
    {
        ...
        public void Serialize(ref MessagePackWriter writer, global::FigNetCommon.EntityDefaultState value, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            IFormatterResolver formatterResolver = options.Resolver;
            writer.WriteArrayHeader(1);
            formatterResolver.GetFormatterWithVerify<global::System.Collections.Generic.List<global::System.Collections.Generic.KeyValuePair<byte, global::FigNet.KernNetz.EntangleState>>>().Serialize(ref writer, value.states, options);
        }
        ...
        public global::FigNetCommon.EntityDefaultState Deserialize(ref MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            IFormatterResolver formatterResolver = options.Resolver;
            var length = reader.ReadArrayHeader();
            var __states__ = default(global::System.Collections.Generic.List<global::System.Collections.Generic.KeyValuePair<byte, global::FigNet.KernNetz.EntangleState>>);
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                {
                    case 0:
                        __states__ = formatterResolver.GetFormatterWithVerify<global::System.Collections.Generic.List<global::System.Collections.Generic.KeyValuePair<byte, global::FigNet.KernNetz.EntangleState>>>().Deserialize(ref reader, options);
                        break;
                    default:
                        reader.Skip();
                        break;
